...
| CSS | Plain CSS + CSS custom properties + Responsive Media Queries | Responsive, mobile-first styling; no build step required; Steve gets a modern, attractive, and responsive result |
